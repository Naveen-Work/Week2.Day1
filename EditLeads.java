...
public class EditLeads {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Naveen2");		
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Kumar");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Naveen2");
		...
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Updating Notice details");		
